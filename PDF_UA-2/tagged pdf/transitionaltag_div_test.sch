...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron"
    ...
    <sch:pattern name = "Checking the validationReport: rules">
        <sch:rule context="/report/jobs/job/validationReport/details">
            <sch:assert test="(@failedRules = '1654')">Failed check, Expected: 1654</sch:assert>	
        </sch:rule>
    ...
    <sch:pattern>
        ...
        <sch:rule context="/report/jobs/job/validationReport/details/rule">
            ...
            (@clause = 'Table 5. Em-Div' and @testNumber = '1' and @failedChecks = '4') or 
            (@clause = 'Table 5. H-Div' and @testNumber = '1' and @failedChecks = '4') or 
            (@clause = 'Table 5. Hn-Div' and @testNumber = '1' and @failedChecks = '24') or 
            (@clause = 'Table 5. L-Div' and @testNumber = '1' and @failedChecks = '4') or 
            (@clause = 'Table 5. Lbl-Div' and @testNumber = '1' and @failedChecks = '4') or 
            (@clause = 'Table 5. P-Div' and @testNumber = '1' and @failedChecks = '4') or 
            (@clause = 'Table 5. Quote-Div' and @testNumber = '1' and @failedChecks = '4') or 
            (@clause = 'Table 5. RB-Div' and @testNumber = '1' and @failedChecks = '4') or 
            (@clause = 'Table 5. RP-Div' and @testNumber = '1' and @failedChecks = '4') or 
            (@clause = 'Table 5. RT-Div' and @testNumber = '1' and @failedChecks = '4') or 
            (@clause = 'Table 5. Ruby-Div' and @testNumber = '1' and @failedChecks = '4') or 
            (@clause = 'Table 5. Span-Div' and @testNumber = '1' and @failedChecks = '4') or 
            (@clause = 'Table 5. Strong-Div' and @testNumber = '1' and @failedChecks = '4') or 
            (@clause = 'Table 5. StructTreeRoot-Div' and @testNumber = '1' and @failedChecks = '13') or 
            (@clause = 'Table 5. Sub-Div' and @testNumber = '1' and @failedChecks = '4') or 
            (@clause = 'Table 5. TBody-Div' and @testNumber = '1' and @failedChecks = '4') or 
            (@clause = 'Table 5. TFoot-Div' and @testNumber = '1' and @failedChecks = '4') or 
            (@clause = 'Table 5. THead-Div' and @testNumber = '1' and @failedChecks = '4') or 
            (@clause = 'Table 5. TOC-Div' and @testNumber = '1' and @failedChecks = '4') or 
            (@clause = 'Table 5. TR-Div' and @testNumber = '1' and @failedChecks = '4') or 
            (@clause = 'Table 5. Table-Div' and @testNumber = '1' and @failedChecks = '4') or 
            (@clause = 'Table 5. WP-Div' and @testNumber = '1' and @failedChecks = '4') or 
            (@clause = 'Table 5. WT-Div' and @testNumber = '1' and @failedChecks = '4') or 
            (@clause = 'Table 5. Warichu-Div' and @testNumber = '1' and @failedChecks = '4')">Failed rules, Expected: 
            Table 5. Em-Div-1, 4 checks, or 
            Table 5. H-Div-1, 4 checks, or 
            Table 5. Hn-Div-1, 24 checks, or 
            Table 5. L-Div-1, 4 checks, or 
            Table 5. Lbl-Div-1, 4 checks, or 
            Table 5. P-Div-1, 4 checks, or 
            Table 5. Quote-Div-1, 4 checks, or 
            Table 5. RB-Div-1, 4 checks, or 
            Table 5. RP-Div-1, 4 checks, or 
            Table 5. RT-Div-1, 4 checks, or 
            Table 5. Ruby-Div-1, 4 checks, or 
            Table 5. Span-Div-1, 4 checks, or 
            Table 5. Strong-Div-1, 4 checks, or 
            Table 5. StructTreeRoot-Div-1, 13 checks, or 
            Table 5. Sub-Div-1, 4 checks, or 
            Table 5. TBody-Div-1, 4 checks, or 
            Table 5. TFoot-Div-1, 4 checks, or 
            Table 5. THead-Div-1, 4 checks, or 
            Table 5. TOC-Div-1, 4 checks, or 
            Table 5. TR-Div-1, 4 checks, or 
            Table 5. Table-Div-1, 4 checks, or 
            Table 5. WP-Div-1, 4 checks, or 
            Table 5. WT-Div-1, 4 checks, or 
            Table 5. Warichu-Div-1, 4 checks</sch:assert>
        </sch:rule>
