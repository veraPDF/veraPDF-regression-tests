...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron"
    ...
    <sch:pattern name = "Checking the validationReport: rules">
        <sch:rule context="/report/jobs/job/validationReport/details">
            <sch:assert test="(@failedRules = '1277')">Failed check, Expected: 1277</sch:assert>	
        </sch:rule>
        ...
        <sch:rule context="/report/jobs/job/validationReport/details/rule">
            ...
            (@clause = '6.2' and @testNumber = '12' and @failedChecks = '9') or 
            ...
            (@clause = '6.2' and @testNumber = '1548' and @failedChecks = '2') or 
            ...
            (@clause = '8.2.5.27' and @testNumber = '1' and @failedChecks = '114') or 
