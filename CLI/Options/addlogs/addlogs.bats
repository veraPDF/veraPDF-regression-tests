...
@test "--addlogs, Add logs to mrr, json or html report. mrr" {
    ...
    run verapdf/verapdf $BATS_TEST_DIRNAME/6.1.3-01-fail-5.pdf --addlogs --format mrr
...
@test "--addlogs, Add logs to mrr, json or html report. html" {
    ...
    run verapdf/verapdf $BATS_TEST_DIRNAME/6.1.3-01-fail-5.pdf --addlogs --format html
