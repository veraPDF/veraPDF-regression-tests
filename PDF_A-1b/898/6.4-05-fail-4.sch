...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron"
    ...
    <!-- Issue# 898 -->
    <!-- https://github.com/veraPDF/veraPDF-library/issues/898 -->
    <!-- File: 6.4-05-fail-4.pdf -->
    ...
    <sch:pattern>name = "Checking the validationReport: rules"
        ...
        <sch:rule context="/report/jobs/job/validationReport/details/rule">
            <sch:assert test="(@clause = '6.4' and @testNumber = '6' and @failedChecks = '1')">Failed rules, Expected: 
            6.4-6, 1 check</sch:assert>
        </sch:rule>
