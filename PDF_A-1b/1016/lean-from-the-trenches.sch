...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron"
    ...
    <sch:pattern>name = "Checking the validationReport: rules"
        ...
        <sch:rule context="/report/jobs/job/validationReport/details/rule">
            <sch:assert test="(@clause = '6.2.3' and @testNumber = '4' and @failedChecks = '7772') or 
            (@clause = '6.2.3' and @testNumber = '2' and @failedChecks = '5154') or 
            ...
            6.2.3, 7772 checks, or 
			6.2.3, 5154 checks, or 
			6.3.7, 165 checks, or 
			6.5.3, 1254 checks, or 
			6.7.3, 1 checks, or 
			6.1.12, 164 checks, or 
			6.5.3, 1089 checks, or 
			6.7.9, 3 checks, or 
			6.4, 500 checks, or 
			6.4, 76 checks, or 
			6.3.4, 4 checks, or 
