...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron"
    ...
    <!-- File: 260308lacmfinalsubmission.pdf -->
    ...
    <sch:pattern name = "Checking the validationReport: rules">
        ...
        <sch:rule context="/report/jobs/job/validationReport/details/rule">
            ...
            (@clause = '6.2.3.3' and @testNumber = '3' and @failedChecks = '11635') or
            (@clause = '6.7.9' and @testNumber = '2' and @failedChecks = '1') or
            (@clause = '6.7.9' and @testNumber = '3' and @failedChecks = '1') or
            (@clause = '6.3.4' and @testNumber = '1' and @failedChecks = '9')">Failed rules, Expected: 
            6.3.5-3, 3 checks, or 
            6.2.3.3-3, 11635 checks, or
            6.7.9-2, 1 check, or
            6.7.9-3, 1 check, or
