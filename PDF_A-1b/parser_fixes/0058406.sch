...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron"
    ...
    <sch:pattern name = "Checking the taskException">
        <sch:rule context="/report/jobs/job/taskException">
            <sch:assert test='contains(exceptionMessage, "Exception: Caught unexpected exception during parsing caused by exception: Entry Prev in trailer is indirect")'>
                Failed check, Expected Error: Exception: Caught unexpected exception during parsing caused by exception: Entry Prev in trailer is indirect
            </sch:assert>
        </sch:rule>
    </sch:pattern>
    ...
    <sch:pattern name = "Checking the logs">
        ...
        <sch:rule context="/report/jobs/job/logs/logMessage">
            ...
            'WARNING: 0058406.pdf doesn't appear to be a valid PDF.' with 1 occurrences</sch:assert>
        </sch:rule>
    </sch:pattern>
