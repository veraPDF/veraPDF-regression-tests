...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron"
    ...
    <sch:pattern name = "Checking the logs">
        ...
        <sch:rule context="/report/jobs/job/logs/logMessage">
            ...
            (contains(., "Stream length has wrong value or is missing(offset = 40)") and @occurrences = "1" and @level = "WARNING")'>Invalid logs, Expected: 
            'WARNING: 00.pdf doesn't appear to be a valid PDF.' with 1 occurrences, or 
            'WARNING: Stream length has wrong value or is missing(offset = 40)' with 1 occurrences</sch:assert>
        </sch:rule>
    </sch:pattern>
