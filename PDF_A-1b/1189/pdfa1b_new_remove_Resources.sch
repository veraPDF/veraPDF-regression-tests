...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron"
    ...
    <sch:pattern name = "Checking the logs">
        ...
        <sch:rule context="/report/jobs/job/logs/logMessage">
            <sch:assert test='(contains(., "Missing /Resources entry or inherited resources in the page dictionary") and @occurrences = "2" and @level = "WARNING") or 
            ...
            'WARNING: Missing /Resources entry or inherited resources in the page dictionary' with 2 occurrences, or 
