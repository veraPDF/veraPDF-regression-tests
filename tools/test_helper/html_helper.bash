...
get_last_plugins_version() {
    ...
    echo "FOLDER: $1" >&3
    BUILD_VERSION=$(curl https://jenkins.openpreservation.org/job/veraPDF/job/$1/job/plugins/lastBuild/ | grep -o 'class="jenkins-icon-adjacent">Build [0-9].[0-9][0-9].[0-9]-REL[0-9]' | grep -o [0-9].[0-9][0-9].[0-9]-REL[0-9])
